import { readPackageJson, writePackageJson, yarn, shell } from 'ern-core';
...
export async function addRNDepToPjson(dir: string, version: string) {
  ...
  // For React Native 0.73+, also add required dependencies
  ...
  if (semver.gte(version, '0.73.0')) {
    ...
    compositePackageJson.dependencies['@react-native-community/cli-platform-android'] = '15.0.1';
    compositePackageJson.dependencies['@react-native-community/cli-platform-ios'] = '15.0.1';
  }
